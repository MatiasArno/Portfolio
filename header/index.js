...
function changeMenuStyleAccordingUrl(currentUrl, menuEl, menuElements) {
    ...
    if (currentUrl.includes("contact")) {
        ...
        menuElements.links.forEach(item => item.style.color = "rgb(72, 72, 72)");
        menuElements.links.forEach(item => item.style.backgroundColor = "#ffffff00");
        menuElements.bars.forEach(item => item.style.backgroundColor = "rgb(90, 90, 90)");
    }
}
